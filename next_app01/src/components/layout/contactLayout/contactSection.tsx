    ...
    <section className="w-full bg-slate-600 py-10">
      ...
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="mb-2 max-w-2xl mx-auto">
          ...
          precisar de suporte, não hesite em entrar em contato conosco. Nossa
      ...
      >
        ...
        <button
          ...
          className="mt-6 w-full bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700 transition-colors disabled:opacity-50"
        >
